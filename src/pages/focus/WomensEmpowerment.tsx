...
import womensEmpowermentImg from "@/assets/generated/focus/womens-empowerment.jpg";
...
const WomensEmpowerment = () => {
  return (
    <FocusPageLayout
      ...
      heroImage={womensEmpowermentImg}
      ...
      initiatives={[
        { title: "Self-Help Groups", description: "Formation and support of women's self-help groups for collective savings, micro-credit, and community development activities." },
        { title: "Vocational Training", description: "Skill development programs in tailoring, handicrafts, food processing, and computer literacy for economic independence." },
        { title: "Health Awareness", description: "Workshops on maternal health, nutrition, and hygiene to ensure women and their families lead healthier lives." },
        { title: "Financial Literacy", description: "Training programs on savings, budgeting, and basic accounting to help women manage their finances effectively." },
        { title: "Leadership Development", description: "Building confidence and leadership skills to enable women to take active roles in community decision-making." },
        { title: "Legal Awareness", description: "Educating women about their legal rights and providing support for accessing justice and government schemes." },
      ]}
      stats={[
