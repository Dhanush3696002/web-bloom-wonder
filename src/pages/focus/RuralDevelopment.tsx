...
const RuralDevelopment = () => {
  return (
    <FocusPageLayout
      ...
      initiatives={[
        { title: "Clean Water Access", description: "Installing water purification systems, borewells, and pipeline networks to ensure safe drinking water in villages." },
        { title: "Sanitation Facilities", description: "Building toilets and promoting hygiene practices to improve health outcomes and dignity in rural areas." },
        { title: "Healthcare Camps", description: "Organizing regular health check-up camps with specialist doctors to bring medical care to remote villages." },
        { title: "School Infrastructure", description: "Improving school buildings, providing furniture, and setting up computer labs in rural schools." },
        { title: "Agricultural Support", description: "Training farmers in sustainable practices, organic farming, and connecting them to markets for better prices." },
        { title: "Road & Connectivity", description: "Advocating for and supporting improved road connectivity and internet access in rural areas." },
      ]}
      stats={[
