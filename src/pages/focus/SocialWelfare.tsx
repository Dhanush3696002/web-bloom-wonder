...
import socialWelfareImg from "@/assets/generated/focus/social-welfare.jpg";
...
const SocialWelfare = () => {
  return (
    <FocusPageLayout
      ...
      initiatives={[
        { title: "Elderly Care", description: "Support services for senior citizens including health check-ups, mobility aids, and social engagement programs." },
        { title: "Disability Support", description: "Providing wheelchairs, prosthetics, and assistive devices along with rehabilitation support for persons with disabilities." },
        { title: "Orphan Support", description: "Educational sponsorship and essential supplies for orphaned children to ensure they have opportunities for a better future." },
        { title: "Food Distribution", description: "Regular distribution of groceries and cooked meals to families in crisis and during natural disasters." },
        { title: "Emergency Relief", description: "Rapid response assistance during floods, fires, and other emergencies affecting vulnerable communities." },
        { title: "Medical Assistance", description: "Financial support for critical medical treatments and surgeries for those who cannot afford healthcare." },
      ]}
      stats={[
